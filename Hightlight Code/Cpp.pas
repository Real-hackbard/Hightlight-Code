...
function TCppToHTML.Convert(DelphiText: string;
...
function TCppToHTML.GetWord(nByte: Integer; S: string): string;
var
  I: Integer;
begin
  Result := '';
...
function TCppToHTML.IsReservWord(S: string): Boolean;
var
  I: Integer;
begin
  Result := False;
...
function TCppToHTML.IsValue(S: string): Boolean;
var
  I: Integer;
begin
  Result := False;
...
procedure TCppToHTML.LoadReservList;
begin
...
procedure TCppToHTML.ReplaceText(CharNum: Integer; OldText,

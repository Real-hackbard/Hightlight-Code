...
function TPythonToHTML.Convert(DelphiText: string;
...
constructor TPythonToHTML.Create;
begin
...
destructor TPythonToHTML.Destroy;
begin
  ReservList.Free;
  DelphiList.Free;
  HTMLList.Free;
...
function TPythonToHTML.GetWord(nByte: Integer; S: string): string;
var
  I: Integer;
begin
  Result := '';
...
function TPythonToHTML.IsReservWord(S: string): Boolean;
var
  I: Integer;
begin
  Result := False;
...
function TPythonToHTML.IsValue(S: string): Boolean;
var
  I: Integer;
begin
  Result := False;
...
procedure TPythonToHTML.LoadReservList;
begin
...
procedure TPythonToHTML.ReplaceText(CharNum: Integer; OldText,

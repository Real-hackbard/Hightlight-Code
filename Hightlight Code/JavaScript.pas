...
type
  TJavaScriptToHTML = class(TObject)
  private
...
function TJavaScriptToHTML.Convert(DelphiText: string;
...
constructor TJavaScriptToHTML.Create;
begin
...
destructor TJavaScriptToHTML.Destroy;
begin
  ReservList.Free;
  DelphiList.Free;
  HTMLList.Free;
...
function TJavaScriptToHTML.GetWord(nByte: Integer; S: string): string;
var
  I: Integer;
begin
  Result := '';
...
function TJavaScriptToHTML.IsReservWord(S: string): Boolean;
var
  I: Integer;
begin
  Result := False;
...
function TJavaScriptToHTML.IsValue(S: string): Boolean;
var
  I: Integer;
begin
  Result := False;
...
procedure TJavaScriptToHTML.LoadReservList;
begin
  with ReservList do begin

  Add('#include'); Add('namespace');
  Add('cout'); Add('cin');
  Add('const'); Add('int');
  Add('strand'); Add('for');
...
procedure TJavaScriptToHTML.ReplaceText(CharNum: Integer; OldText,
